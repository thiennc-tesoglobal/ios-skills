...
This project is indexed by GitNexus as **ios-skills** (9007 symbols, 9389 relationships, 8 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
