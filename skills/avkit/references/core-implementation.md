# AVKit Core Implementation Details
...
pattern in [references/avkit-patterns.md](avkit-patterns.md).
...
the current playback context. See [references/avkit-patterns.md](avkit-patterns.md)
