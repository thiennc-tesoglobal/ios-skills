# TabletopKit Core Implementation Details
...
See [references/tabletopkit-patterns.md](tabletopkit-patterns.md) for card fan, grid, and overlap layout examples.
...
[references/tabletopkit-patterns.md](tabletopkit-patterns.md)
...
Load [State Bookmarks and Undo](tabletopkit-patterns.md#state-bookmarks-and-undo)
...
rather than deprecated `setAllowedDestinations(_:)` or
...
See [references/tabletopkit-patterns.md](tabletopkit-patterns.md) for group
...
[references/tabletopkit-patterns.md](tabletopkit-patterns.md) for custom
